/* *******************************************
// LICENSE INFORMATION
// The code, "Detecting Smartphones Using ASP.NET" 
// by Anthony Hand, is licensed under a Creative Commons 
// Attribution 3.0 United States License.
//
// Updated 02 January 2010 by A Hand
//   - Added  values and methods to detect two classes
//     of BlackBerry devices: High and Low.
//   - Updated the checks for the DetectTierIphone method
//   - Replaced the DetectTierSmartphone method with a
//     new one called DetectTierRichCss.
//   - Updated the checks for the DetectTierOtherPhones method.
//   - Added values and methods to pre-populate Tier detection variables. 
//     These methods do the Tier detection calls once so they  
//     don't have to be called multiple times. 
//   - Added support for Garmin Nuviphone
//   - Updated the DetectSmartphone method.
//
...
//   - Ported to C# ASP.NET from the PHP code by 
//     Brad Rigg, brigg@corporatenetworkecom.com
//
